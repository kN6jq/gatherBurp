...
public class DbUtils {
    ...
    public static void create() {
        ...
        try {
            ...
            sqls.add("INSERT INTO \"config\" VALUES (79, 'sql', 'sqlErrorKey', 'DB2 SQL error:|XXXXX|internal error |XXXXX|SQLSTATE=|XXXXX|[CLI Driver]|XXXXX|Sybase message:|XXXXX|Syntax error in query expression|XXXXX|Data type mismatch in criteria expression.|XXXXX|Microsoft JET Database Engine|XXXXX|ODBC Microsoft Access Driver|XXXXX|PostgreSQL query failed:|XXXXX|supplied argument is not a valid PostgreSQL result|XXXXX|pg_query(|XXXXX|pg_exec(|XXXXX|supplied argument is not a valid MySQL|XXXXX|Column count doesnt match value count at row|XXXXX|mysql_fetch_array(|XXXXX|mysql_|XXXXX|on MySQL result index|XXXXX|You have an error in your SQL syntax;|XXXXX|You have an error in your SQL syntax near|XXXXX|MySQL server version for the right syntax to use|XXXXX|[MySQL][ODBC|XXXXX|Column count doesnt match|XXXXX|the used select statements have different number of columns|XXXXX|com.informix.jdbc|XXXXX|Dynamic Page Generation Error:|XXXXX|An illegal character has been found in the statement|XXXXX|<b>Warning</b>:  ibase_|XXXXX|Dynamic SQL Error|XXXXX|[DM_QUERY_E_SYNTAX]|XXXXX|has occurred in the vicinity of:|XXXXX|syntax error|XXXXX|A Parser Error (syntax error)|XXXXX|java.sql.SQLException|XXXXX|Unexpected end of command in statement|XXXXX|[Macromedia][SQLServer JDBC Driver]|XXXXX|System.Data.OleDb.OleDbException|XXXXX|[SQL Server]|XXXXX|[Microsoft][ODBC SQL Server Driver]|XXXXX|[SQLServer JDBC Driver]|XXXXX|[SqlException|XXXXX|System.Data.SqlClient.SqlException|XXXXX|Unclosed quotation mark after the character string|XXXXX|mssql_query(|XXXXX|odbc_exec(|XXXXX|Microsoft OLE DB Provider for ODBC Drivers|XXXXX|Microsoft OLE DB Provider for SQL Server|XXXXX|Incorrect syntax near|XXXXX|Sintaxis incorrecta cerca de|XXXXX|Syntax error in string in query expression|XXXXX|ADODB.Field|XXXXX|Procedure requires parameter|XXXXX|ADODB.Recordset|XXXXX|Unclosed quotation mark before the character string');");
